...
const DataSelection = ({ loggedUser }) => {
    ...
    const steps = ['Catalog Selection', 'Data Source Selection', 'Data Selection'];
                                                                ...
                                                                <Collapse in={row.open} timeout="auto" unmountOnExit>
                                                                    <Box sx={{ margin: 1 }}>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            onBlur={(e) => handleTableDescriptionChange(bucketIndex, rowIndex, e.target.innerText)}
                                                                            onFocus={(e) => e.target.innerText = row.description} // Reset the text on focus
